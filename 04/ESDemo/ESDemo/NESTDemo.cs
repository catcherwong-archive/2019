namespace ESDemo
{
    ...
    class NESTDemo
    {
        ...
        private void IndexDoc(ElasticClient client)
        {
            ...
            Console.WriteLine("IndexDocument result:");
            Console.WriteLine(JsonConvert.SerializeObject(indexResponse));
            Console.WriteLine("=========");
        }

        private void IndexMultiDoc(ElasticClient client)
        {
            ...
            Console.WriteLine("IndexMany result:");
            Console.WriteLine(JsonConvert.SerializeObject(indexResponse));
            Console.WriteLine("=========");
        }

        private void SearchDoc_Term(ElasticClient client)
        {
        ...
        private void SearchDoc_Must(ElasticClient client)
        {
            var searchRequest = new SearchRequest<Product>(Indices.Parse("esdemo"), Types.Parse("product"))
            {
                From = 0,
        ...
        private void SearchDoc_ById(ElasticClient client)
        {
        ...
        private void SearchDoc_WildcardAndDataRange(ElasticClient client)
        {
            var searchRequest = new SearchRequest<Product>(Indices.Parse("esdemo"), Types.Parse("product"))
            {
                From = 0,
